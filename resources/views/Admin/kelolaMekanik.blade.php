...
<body>
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2">
                <a class="nav-link" href="{{ route('homePengguna') }}">
            ...
            <div class="card-body">
                ...
                <div class="d-flex mb-3">
                    <form action="{{ route('kelolaMekanik') }}" method="GET" class="d-flex me-2">
                        <input type="search" id="" name="kontak" class="input form-control rounded me-2" placeholder="Cari Kontak Mekanik">
                        <button type="submit" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                    ...
                    <table class="table table-striped table-bordered" id="example">
                        ...
                        <tbody class="text-center">
                            @foreach ($m as $item)
                                <tr>
                                    <td>{{ $item->id }}</td>
                                    <td><img src="{{ asset($item->profil) }}" alt="Profil" width="50"></td>
                                    <td>{{ $item->nama }}</td>
                                    <td>{{ $item->email }}</td>
                                    <td>{{ $item->alamat }}</td>
                                    <td>{{ $item->kontak }}</td>
