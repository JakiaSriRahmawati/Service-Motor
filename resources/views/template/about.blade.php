...
<div class="container mt-5 pt-5">
    <h1 class="mt-5">Welcome to the About us</h1>
    <h2 class="text-dark mb-12 text-center card-title font-weight-bold">Servis Motor Zackk</h2>
        {{-- awal row 1 --}}
        <div class="row">
            <div class="col-md-8">
                <p class="card-text">Zackk adalah toko ritel modern yang mengkhususkan diri dalam menyediakan
                    ...
                    produk-produk terbaik serta berkualitas bagi pemilik sepeda motor di Indonesia. kami hadir lebih dekat dengan masyarakat Indonesia. Dukungan dari 7
                    Juta pelanggan di seluruh negeri membuktikan kepercayaan yang diberikan kepada kami untuk memenuhi
                    kebutuhan suku cadang sepeda motor. Ini memotivasi kami untuk terus berinovasi dan menyediakan
        ...
        <div class="row">
            <div class="container">
                <div class="title">
                    <h2>SEJARAH</h2>
                    <h3 style="color: red; font-weight: bold;">PT. NUSANTARA BATAVIA INTERNATIONAL</h3>
                </div>
                <div class="timeline">
                    <div class="timeline-item">
                        <h4 style="color: red;">1995 - 2001</h4>
                    ...
                    <div class="timeline-item">
                        <h4 style="color: red;">2002 - 2007</h4>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                            the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley
                            of type and scrambled it to make a type specimen book. It has survived not only five centuries,
                            but also the leap into electronic typesetting, remaining essentially unchanged. It was
        ...
        <div class="row text-center">
            ...
            <div class="banner d-flex px-4 justify-content-between align-items-center">
                <h2 style="font-weight: bold;">PT. NUSANTARA BATAVIA INTERNATIONAL</h2>
